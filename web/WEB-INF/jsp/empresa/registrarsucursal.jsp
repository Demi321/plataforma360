...
<spring:url value="${pathRecursos}/empresas360/registrarsucursal/registrarsucursal.css" var="modulo_registrarsucursalCSS" />
<spring:url value="${pathRecursos}/empresas360/registrarsucursal/registrarsucursal.js" var="modulo_registrarsucursalJS" />
