<%-- 
    Document   : modulo_mis_sucursales
    Created on : 24/11/2020, 10:40:13 AM
    Author     : global
--%>
...
<spring:url value="${pathRecursos}/css/Empresa/modulo_mis_sucursales.css" var="modulo_mis_sucursalesCSS" />
<spring:url value="${pathRecursos}/js/Empresa/modulo_mis_sucursales.js" var="modulo_mis_sucursalesJS" />
<link href="${modulo_mis_sucursalesCSS}" rel="stylesheet"/>
<script src="${modulo_mis_sucursalesJS}" ></script>
