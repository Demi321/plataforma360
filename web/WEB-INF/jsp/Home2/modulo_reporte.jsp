            ...
            <div class="row col-12 m-0 p-2 pt-3">
                ...
                <div class="col-12 col-sm-12 col-md-8 p-0">
                    ...
                    <div class="form-group row m-0 p-2">
                         <label class="col-sm-2 col-form-label d-flex justify-content-center align-items-left">Fecha:</label>
                        <div class="col-sm-4"><input type="date" class="form-control-plaintext input" id="fecha_reporte" placeholder="Fecha" disabled="true"/></div>
                        <label class="col-sm-2 col-form-label d-flex justify-content-center align-items-left">Hora:</label>
                        <div class="col-sm-4"><input type="time" class="form-control-plaintext input" id="hora_reporte" placeholder="Hora" /></div>
                    </div>
                    <div class="form-group row m-0 p-2">
                    ...
                    <div class="form-group row m-0 p-2 ">
                        ...
                        <div class="col-sm-10" >
                            <input type="text" class="form-control-plaintext input" id="d_autocompletar5" value="" placeholder="Ingresa una dirección." autocomplete="off" required="true"/>
                        </div>
                ...
                <div class="row m-0 col-12 col-sm-12 col-md-4 p-0" style="
                    ...
                    <div class="col-12 p-1" id="map5"></div>
                </div>
...
<spring:url value="${pathRecursos}/Home/modulos/reporte/reporte.css" var="modulo_reporteCSS" />
<spring:url value="${pathRecursos}/Home/modulos/reporte/reporte.js" var="modulo_reporteJS" />
<link href="${modulo_reporteCSS}" rel="stylesheet"/>
<script src="${modulo_reporteJS}" ></script>
