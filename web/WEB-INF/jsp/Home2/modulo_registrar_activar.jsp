<%-- 
    Document   : modulo_registrar_activar
    Created on : 24/11/2020, 10:35:43 AM
    Author     : global
--%>
...
<spring:url value="${pathRecursos}/css/Empresa/modulo_registro_empresa.css" var="modulo_registro_empresaCSS" />
<spring:url value="${pathRecursos}/js/Empresa/modulo_registro_empresa.js" var="modulo_registro_empresaJS" />
<link href="${modulo_registro_empresaCSS}" rel="stylesheet"/>
<script src="${modulo_registro_empresaJS}" ></script>
