...
<spring:url value="${pathRecursos}/Home/modulos/entrada_salida/entrada_salida.css" var="modulo_entrada_salidaCSS" />
<spring:url value="${pathRecursos}/Home/modulos/entrada_salida/entrada_salida.js" var="modulo_entrada_salidaJS" />
