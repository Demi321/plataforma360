...
<link href="${pathRecursos}/css/referencias_hospitalarias/institucion.css" rel="stylesheet" />
    <script src="${pathRecursos}/js/referencias_hospitalarias/institucion.js"></script>
