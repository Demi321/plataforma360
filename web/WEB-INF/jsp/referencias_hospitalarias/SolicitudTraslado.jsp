                        ...
                        <div class="col-12 formulario">
                            ...
                            <div class="form-row mb-3">
                                <div class="col-12 encabezados">
                                    <label for="fechayhora">Selecciona una intitución.</label>
                                </div>
                                <div class="col-12 encabezados">
                                    <select
                                            class="form-control-plaintext input p-2 m-0 mb-1 col-sm-12"
                                            required="true"
                                            id="listado_instituciones_referencia"
                                            style="font: bold 1.5rem Arial; border-top: none; border-right: none; border-left: none; border-image: initial; background: #40474f; border-bottom: 2px solid #f5f5f5; color: white;"
                                    >
...
<link href="${pathRecursos}/css/referencias_hospitalarias/solicitudtraslado.css" rel="stylesheet" />
<script src="${pathRecursos}/js/referencias_hospitalarias/solicitudtraslado.js"></script>
