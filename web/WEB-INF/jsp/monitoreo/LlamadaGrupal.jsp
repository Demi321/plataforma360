            ...
            <div id="sidebar">
                  ...
                  <div class="row m-0 p-0 h-50" style="position: relative;">
                        ...
                        <div style="height: calc(100% - 30px); position: absolute; width: 100%; overflow: scroll; top:30px;">
                              <div class="row col-12 mx-auto mt-1 d-none" style="padding: 0;">
                                    <div class="col-8">
                              ...
                              <div class="row col-12 mx-auto mt-1" style="padding: 0;">
                                    <div class="col-8">
                                          <label class="label-default" style="margin: 0; height: 15px; margin-top: 10px; font: 12px Arial;    color: #ff8200; ">Notas:</label>
                                    </div>
<!--                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                          <textarea type="text" placeholder="Escribe tus notas aquí..." 
                                                    style="font: 12px Arial;
                                                    width: 100%; 
                                                    border-radius: 3px; " 
                                                    class="form-control" 
                                                    id="notas" name="notas" rows="3" cols="80" required="required"></textarea>
                                    </div>
                              </div> 
                              <div class="row col-12 mx-auto mt-1" style="padding: 0;">
                                    <div class="col-8">
                                          <label class="label-default" 
                                                 ...
                                                 margin-top: 10px; 
                                                 font: 12px Arial;    
                                                 color: #ff8200; ">Acuerdos y Conclusiones:</label>
                                    </div>
<!--                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                          <textarea type="text" placeholder="Escribe tus acuerdos y conclusiones aquí..." 
                                                    style="font: 12px Arial; width: 100%; border-radius: 3px; " 
                                                    class="form-control" 
                                                    id="acuerdos_conclusiones" 
                                                    name="acuerdos_conclusiones" 
                                                    rows="8" 
                                                    cols="80" ></textarea>
                                    </div>
                              </div> 
      ...
      <script src="${pathRecursos}/js/Empresa/appEmpresa.js" ></script>
      <script async defer
