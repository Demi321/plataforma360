        ...
        <div class="col-12 col-sm-12 col-md-8 p-0">
            ...
            <div class="form-group row m-0 p-2">
             ...
             <div class="form-group row m-0 p-2">
                ...
                <div class="col-sm-10"><input type="number" class="form-control-plaintext input" id="calificacion_tarea" placeholder="Calificación"/></div>
            </div>
             <div class="form-group row m-0 p-2">
               <button class="btn btn-success" onclick="calificar(${id_usuario},${tarea[0].id_evaluacion},${tarea[0].id_grupo})">Calificar.</button>
            </div>
