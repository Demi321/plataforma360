                        ...
                        <div class="col-12 formulario">
                            ...
                            <div class="form-row">
                                <div class="col-4 col-md-3 col-lg-3 col-xl-4">
                                    ...
                                    <input type="text" class="form-control" id="fecha_registro_paciente" name="fecha"  disabled>
                                </div>
                                <div class="col-4 col-md-3 col-lg-3 col-xl-4">
                                    <label for="hora">Hora</label>
                                    <input type="text" class="form-control" id="hora_registro_paciente" name="hora"  disabled>
                                </div>
