...
<head>  
    ...
    <spring:url value="${pathRecursos}/css/Empresa/registro_empresa.css" var="registro_empresaCSS" />

    <%-- Javascript Personalizados --%>    
    <spring:url value="${pathRecursos}/js/Empresa/registro_empresa.js" var="registro_empresaJS" />
...
<!--                                <option value="3057">Rocket Inc. 1 </option>
    ...
    <link href="${registro_empresaCSS}" rel="stylesheet" />
    <script src="${registro_empresaJS}" ></script>
