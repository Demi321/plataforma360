<%-- 
    Document   : modulo_mi_empresa
    Created on : 24/11/2020, 10:39:25 AM
    Author     : global
--%>
...
<spring:url value="${pathRecursos}/css/Empresa/modulo_mi_empresa.css" var="modulo_mi_empresaCSS" />
<spring:url value="${pathRecursos}/js/Empresa/modulo_mi_empresa.js" var="modulo_mi_empresaJS" />
<link href="${modulo_mi_empresaCSS}" rel="stylesheet"/>
<script src="${modulo_mi_empresaJS}" ></script>