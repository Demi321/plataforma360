<%-- 
    Document   : modulo_registrar_sucursal
    Created on : 24/11/2020, 10:36:33 AM
    Author     : global
--%>
...
<spring:url value="${pathRecursos}/css/Empresa/modulo_registrar_sucursal.css" var="modulo_registrar_sucursalCSS" />
<spring:url value="${pathRecursos}/js/Empresa/modulo_registrar_sucursal.js" var="modulo_registrar_sucursalJS" />
<link href="${modulo_registrar_sucursalCSS}" rel="stylesheet"/>
<script src="${modulo_registrar_sucursalJS}" ></script>