...
<spring:url value="${pathRecursos}/css/Empresa/modulo_reporte.css" var="modulo_reporteCSS" />
<spring:url value="${pathRecursos}/js/Empresa/modulo_reporte.js" var="modulo_reporteJS" />
