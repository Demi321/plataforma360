            ...
            <div class="row col-12 m-0 p-2 pt-3">
                ...
                <div class="col-12 col-sm-12 col-md-8 p-0">
                    ...
                    <div class="form-group row m-0 p-2">
                        ...
                        <div class="col-sm-10"><input type="text" class="form-control-plaintext input" id="nombre_area" placeholder="Ãrea" /></div>
                    </div>
                    <div class="form-group row m-0 p-2">
                    ...
                    <div class="form-group row m-0 p-2">
                        ...
                        <div class="col-sm-10"><input type="text" class="form-control-plaintext input" id="num_empleado" placeholder="NÃºmero de empleado" /></div>
                    </div>
                    <div class="form-group row m-0 p-2">
