...
<body>
            ...
            <div class="row col-12 m-0 p-0 mt-1 informacion">
                <div class="row col-12 barra">
                    ...
                    <div class="col-4" ><input type="text" id="codigo" style="
                                               ...
                                               width: 100%;
                                               "></div>
                    <div class="col-2" ><input type="text" id="fecha" style="
                                               padding: 8px;
                                               background: no-repeat;
                                               border: none;
                                               color: white;
                                               ...
                                               "></div>
                    <div class="col-5"><input type="text" id="titulo_covid" style="
                                              padding: 8px;
                                              background: no-repeat;
                                              border: none;
                                              color: white;
    ...
    <link href="${pathRecursos}/css/sucre.css" rel="stylesheet" />
    <script src="${pathRecursos}/js/ccb/sucre.js"></script>
