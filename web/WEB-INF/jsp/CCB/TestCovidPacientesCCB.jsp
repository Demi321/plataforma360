...
<body>
                    ...
                    <div id="informacion" class="row col-12 m-0 p-0 h-100">
                        ...
                        <div class="row col-12 m-0 contTest">
                            <div class="col-8 divPregunta">
                                <label class="pregunta" id="pfiebre">¿Has tenido fiebre por más de 3 días?</label>
                            </div>
                            <div class="col-4 divRespuesta">
                                <label class="respuesta" id="rfiebre"></label>
                            </div>
                            <div class="col-8 divPregunta">
                                <label class="pregunta" id="ptemperatura">¿Te has medido la temperatura?</label>
                            </div>
                            <div class="col-4 divRespuesta">
                                <label class="respuesta" id="rtemperatura"></label>
                            </div>
                            <div class="col-8 divPregunta" id="div_pque_temp">
                                <label class="pregunta" id="pque_temp">¿Qué temperatura tuviste?</label>
                            </div>
                            <div class="col-4 divRespuesta" id="div_rque_temp">
                                <label class="respuesta" id="rque_temp"></label>
                            </div>
                            <div class="col-8 divPregunta">
                                <label class="pregunta" id="poxigeno">¿Has medido el oxígeno en tu dedo?</label>
                            </div>
                            <div class="col-4 divRespuesta">
                                <label class="respuesta" id="roxigeno"></label>
                            </div>
                            <div class="col-8 divPregunta" id="div_poxigeno_resultado">
                                <label class="pregunta" id="poxigeno_resultado">¿Cuál fue el resultado?</label>
                            </div>
                            <div class="col-4 divRespuesta" id="div_roxigeno_resultado">
                                <label class="respuesta" id="roxigeno_resultado"></label>
                            </div>
                            <div class="col-8 divPregunta">
                                <label class="pregunta" id="pdificultad_respirar">¿Tienes dificultad para respirar, crees que esté empeorando?</label>
                            </div>
                            <div class="col-4 divRespuesta">
                                <label class="respuesta" id="rdificultad_respirar"></label>
                            </div>
                            <div class="col-8 divPregunta">
                                <label class="pregunta" id="pchifla_pecho">¿Te chifla el pecho al respirar?</label>
                            </div>
                            <div class="col-4 divRespuesta">
                                <label class="respuesta" id="rchifla_pecho"></label>
                            </div>
                            <div class="col-8 divPregunta">
                                <label class="pregunta" id="prespiracion_frecuente">¿Tienes respiración muy frecuente y/o superficial?</label>
                            </div>
                            <div class="col-4 divRespuesta">
                                <label class="respuesta" id="rrespiracion_frecuente"></label>
                            </div>
                            <div class="col-8 divPregunta">
                                <label class="pregunta" id="pdesorientado">¿Te has desorientado, tienes confusión o sientes desvanecimiento?</label>
                            </div>
                            <div class="col-4 divRespuesta">
                                <label class="respuesta" id="rdesorientado"></label>
                            </div>
                            <div class="col-8 divPregunta">
                                <label class="pregunta" id="psangrado">¿Has presentado sangrado por alguna via: nariz, boca o al hacer del baño?</label>
                            </div>
                            <div class="col-4 divRespuesta">
                                <label class="respuesta" id="rsangrado"></label>
                            </div>
                        </div>
                        ...
                        <div id="contDiagnostico" class="contDiagnostico w-100">
                            ...
                            <div class="row col-12 m-0 contIngresar d-none">
    ...
    <link href="${pathRecursos}/css/TestCovidPacientesCCB.css" rel="stylesheet" />
    <script src="${pathRecursos}/js/ccb/TestCovidPacientesCCB.js"></script>
