<%-- 
    Document   : plantilla
    Created on : 22 abr 2020, 16:25:53
    Author     : web
--%>
...
<body>
    ...
    <aside>
        <div class="row col-12 m-0 p-0" id="toggle">Traslado de Referencias COVID-19</div>
        <div id="sidebar">
            <div id="accordion">
            ...
            <!--            <h1>Buscar número de referencia</h1>
    ...
    <section>
        <div class="h-100 row col-12 m-0 p-2" id="contenidoSection">
            <div class="row col-12 m-0 p-0 conteo">
                <p id="titulo" class="titulo"></p>
                <!--                <div class="col-3">
                                    <div class="row stats" id="total_solicitudes">0</div>
                                    <div class="row stats_label">Total de Solicitudes de Referencia Recibidas </div>
                                </div>
                                <div class="col border">
                                    <div class="row stats" id="total_solicitudes_pendientes">0</div>
                                    <div class="row stats_label">Pendientes de Revisión  </div>
                                </div>
                                <div class="col border">
                                    <div class="row stats" id="total_solicitudes_proceso">0</div>
                                    <div class="row stats_label">En Proceso </div>
                                </div>
                                <div class="col border">
                                    <div class="row stats" id="total_solicitudes_ruta">0</div>
                                    <div class="row stats_label">En Ruta de Translado </div>
                                </div>
                                <div class="col border">
                                    <div class="row stats" id="total_solicitudes_rechazado">0</div>
                                    <div class="row stats_label">Rechazadas </div>
                                </div>-->
            </div>
            <div class="row col-12 m-0 p-0 mt-1 informacion">
                ...
                <div class="col-12 contenido_ficha">
                    ...
                    <div class="row col-12 ficha">
                        ...
                        <div class="col-4">
                            <label>Hora de ingreso hospitalario </label>
                            <input type="text" id="hora_ingreso">
                        </div>
                        <div class="col-4">
                            <label>Fecha de recepción hospitalaria </label>
                            <input type="text" id="fecha_recepcion">
                        </div>
                        <div class="col-4">
                            <label>Hora de recepción hospitalaria </label>
                            <input type="text" id="hora_recepcion">
                        </div>
                        <div class="col-4">
    ...
    <link href="${pathRecursos}/css/crum.css" rel="stylesheet" />
    <script src="${pathRecursos}/js/ccb/crum.js"></script>
