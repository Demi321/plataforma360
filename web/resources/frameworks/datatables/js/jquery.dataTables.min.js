...
(function(h) {
    ...
    n.defaults = {
        ...
        fnStateSaveCallback: function(a, b) {
            try {
                (-1 === a.iStateDuration ? localStorage : localStorage).setItem("DataTables_" + a.sInstance + "_" + location.pathname, JSON.stringify(b))
            } catch (c) {}
        },
        ...
        oLanguage: {
            ...
            sInfoFiltered: "(filtrados de _MAX_ totales resultados)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
